...
DATA_PATH = '/Users/leecu/Desktop/semi/RAWDATA/TOTAL/' #데이터경로 설정
print('파일 크기: ')
...
DATA_PATH = '/Users/leecu/Desktop/semi/RAWDATA/TOTAL/' # 데이터 경로 설정
train_data = pd.read_csv(DATA_PATH+'ratings_train.txt', header = 0, delimiter='\t', quoting=3)
...
DEFAULT_PATH  = '/Users/leecu/Desktop/semi/RAWDATA/TOTAL/' # 경로지정
...
#전처리 데이터 불러오기
DATA_PATH = '/Users/leecu/Desktop/semi/RAWDATA/TOTAL/CLEAN_DATA/'
...
# 모델 저장하기
save_model(model,'/Users/leecu/Desktop/semi/RAWDATA/TOTAL/CLEAN_DATA/SAVE_MODEL')
...
model.load_weights('/Users/leecu/CLEAN_DATA/DATA_OUT/cnn_classifier_kr/weights.h5')
model.evaluate(test_input, test_label_data)

# In[ ]:


df = pd.read_excel('GS_TOTAL3.xlsx')
...
tokenizer  = Tokenizer()
DATA_CONFIGS = 'data_configs.json'
prepro_configs = json.load(open('/Users/leecu/Desktop/semi/RAWDATA/TOTAL/CLEAN_DATA/'+DATA_CONFIGS,'r'))
...
#     print(sentence)
    ...
    model.load_weights('/Users/leecu/CLEAN_DATA/DATA_OUT/cnn_classifier_kr/weights.h5') #모델 불러오기
    predictions = model.predict(pad_new)
    predictions = float(predictions.squeeze(-1)[1])
    final_list.append([origin, predictions])
...
col_name = ['text', 'pro']
list_df = pd.DataFrame(final_list, columns=col_name)
